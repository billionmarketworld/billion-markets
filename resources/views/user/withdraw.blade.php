...
<body class="font-sans antialiased m-0 p-0 text-white select-none" style="background-color: #0b0204;">
    ...
    <div class="min-h-screen flex flex-col md:flex-row relative overflow-x-hidden">
        ...
        <main class="flex-grow p-4 md:p-8 flex flex-col space-y-6 overflow-y-auto md:h-screen">
            ...
            <!-- ⚡ হেডার এরিয়া (মোবাইলে নিচে নিচে নামবে flex-col sm:flex-row) -->
            <div class="w-full rounded-lg p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4" style="background-color: #120508; border-left: 4px solid #ff1e27;">
                ...
                <button onclick="document.getElementById('withdrawModal').classList.remove('hidden')" class="w-full sm:w-auto px-5 py-2.5 rounded text-xs font-bold text-white transition hover:bg-red-700 text-center" style="background-color: #b80c14;">
            ...
            <!-- 🛑 উইথড্র ফর্ম পপ-আপ মডাল -->
            <div id="withdrawModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center hidden z-50 p-4">
            ...
            <!-- 📊 টেবিল এরিয়া (মোবাইলে স্ক্রল করার জন্য overflow-x-auto দেওয়া হয়েছে) -->
