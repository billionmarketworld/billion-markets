    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-grow p-8 flex flex-col space-y-6 overflow-y-auto">
            <div class="w-full rounded-lg p-5 flex justify-between items-center" style="background-color: #120508; border-left: 4px solid #ff1e27;">
                ...
                <button onclick="document.getElementById('depositModal').classList.remove('hidden')" class="px-5 py-2.5 rounded text-xs font-bold text-white transition hover:bg-red-700" style="background-color: #b80c14;">
                    <i class="fa-solid fa-plus mr-2"></i>New Deposit
                </button>
            </div>

            <div id="depositModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center hidden z-50">
